...
@Component({
  selector: 'app-seller-update-profile',
  templateUrl: './seller-update-profile.component.html',
  styleUrls: ['./seller-update-profile.component.css']
})
export class SellerUpdateProfileComponent implements OnInit {
